---
title: "EDA LA 2 Pokemon Dataset"
author: "LAKSHMINARASIMHAN,KISHORE"
output:
  pdf_document:
...
pokemon %>%
  ...
  ylab("") 
```
#The below command generates a scatter plot to compare the "attack" and "defense" attributes of each Pokémon. It helps identify any potential relationships or patterns between these attributes.
```{r}
pokemon %>%
